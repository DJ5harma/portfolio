...
const floatingDotAnimation = {
	x: [0, 30, 0],
	y: [0, -30, 0],
	opacity: [0, 1, 0],
};

const floatingDotTransition = (i) => ({
	duration: 4,
	repeat: Infinity,
	delay: i * 0.8,
});
		...
		<section ref={containerRef} className="py-20 px-4 relative overflow-hidden">
								...
								<div className="relative h-64 overflow-hidden">
									...
									<div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
										<div className="flex gap-4">
											...
											{project.github && (
												<OverlayButton asLink href={project.github}>
							...
							<div className="absolute inset-0 pointer-events-none">
								{[...Array(5)].map((_, i) => (
									<motion.div
										...
										animate={floatingDotAnimation}
										transition={floatingDotTransition(i)}
										style={{
											left: `${20 + i * 15}%`,
											top: `${40 + i * 10}%`,
										}}
			...
			{selectedProject && (
				<ProjectModal
					...
					image={getProjectImage(selectedProject.name)}
...
// Reusable Components
const OverlayButton = ({ onClick, children, asLink = false, href = "#" }) =>
	asLink ? (
		<motion.a
			href={href}
			target="_blank"
